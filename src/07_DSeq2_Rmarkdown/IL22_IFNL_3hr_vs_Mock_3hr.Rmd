...
## IL22 + IFNL 3hr vs Mock 3hr

```{r}
datatable(dge$res_3hr_IL22_IFNL, rownames = TRUE, filter="top", class="compact",
           caption = "Differential gene expression analysis - IL22 + IFNL 3hr",
