...
## IL22 + IFNL 6hr vs Mock 6hr

```{r}
datatable(dge$res_6hr_IL22_IFNL, rownames = TRUE, filter="top", class="compact",
          caption = "Differential gene expression analysis - IL22 + IFNL 6hr",
