...
## IL22 + IFNL 12hr vs Mock 12hr

```{r}
datatable(dge$res_12hr_IL22_IFNL, rownames = TRUE, filter="top", class="compact",
           caption = "Differential gene expression analysis - IL22 + IFNL 12hr",
