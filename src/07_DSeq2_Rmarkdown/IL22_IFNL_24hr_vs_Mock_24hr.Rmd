...
## IL22 + IFNL 24hr vs Mock 24hr

```{r}
datatable(dge$res_24hr_IL22_IFNL, rownames = TRUE, filter="top", class="compact",
           caption = "Differential gene expression analysis - IL22 + IFNL 24hr",
